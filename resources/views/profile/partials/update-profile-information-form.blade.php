    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-800 dark:text-white" for="avatar">Upload
                avatar</label>
            <input id="avatar" name="avatar" type="file" accept="image/*" @class([
                //classs normal
                'block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400',
                //class saat ada error
            ...
            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="avatar_help">.png or .jpg (max 1MB)</div>
            @error('avatar')
